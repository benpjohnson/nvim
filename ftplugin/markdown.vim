...
" FIXME: Could we do babel or ipython type blocks to execute code inline or
" even markdown format that supports code blocks?
 ...
 autocmd BufNewFile,BufRead * call TextEnableCodeSnip('php',   '#php',   '#end:php', 'SpecialComment')
 autocmd BufNewFile,BufRead * call TextEnableCodeSnip('sh',   '#sh',   '#end:sh', 'SpecialComment')
 autocmd BufNewFile,BufRead * call TextEnableCodeSnip('dot',   '#dot',   '#end:dot', 'SpecialComment')
